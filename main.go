...
var (
	...
	masterBasicAuthPasswordHash = kingpin.Flag("master.basic-auth.password-hash","password hash for master server's Basic Auth").Default("").Envar("OVPN_MASTER_PASSWORD_HASH").String()
